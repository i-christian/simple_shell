...
#### $$
A second`$` is substitued with the current process ID.
...
* Maxwel honorifica Kajiwonele <[honorifica ](https://github.com/honorifica )>
...
This project was written as part of the curriculum for ALX School. ALX  School is an online-based full-stack software engineering program that prepares students for careers in the tech industry using project-based peer learning. For more information, visit [this link](https://www.alxafrica.com/).
